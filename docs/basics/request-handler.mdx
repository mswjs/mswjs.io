...
Integrating mocking into complex applications may require more flexibility in the way requests are matched, or mocked. For that, Mock Service Worker exposes an API to create your [custom request handlers](/docs/advanced/custom-request-handler).
