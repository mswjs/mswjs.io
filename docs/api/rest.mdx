...
> The path provided to `rest.all()` abides by the [Request matching](/docs/basics/request-matching) algorithm, meaning you can also use patterns and regular experssions.
