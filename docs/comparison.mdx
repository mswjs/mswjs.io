...
> MirageJS is a complex solution for data-driven mocking. Mock Service Worker is a mocking basis, on which you can model data relations using third-party tools.
