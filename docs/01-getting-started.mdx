...
This page will take you through the minimal setup you need to get started with Mock Service Worker. **It assumes you have got a NodeJS-based project bootstrapped and running**.
