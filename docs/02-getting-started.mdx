...
As the next step, we need to copy the Service Worker file in our project's public directory. There is a shorthand CLI command to help us with that:
...
Create a `mocks.js` file where we are going to describe our mocking logic, otherwise referred to as "mock definition".
