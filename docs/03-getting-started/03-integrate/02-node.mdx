...
In this example integration example we are going to write a test suite using [Jest](https://jestjs.io/) framework. Following the same principle, you can integrate mocking into any process running in Node.
...
<Action>
  Pass the mock definitions to the <code>setupWorker</code> function:
</Action>
