...
For such cases, Mock Service Worker allows tracking of network requests through the [Life-cycle events API](https://mswjs.io/docs/extensions/life-cycle-events#tracking-a-request).
