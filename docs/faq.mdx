...
## Should I commit my worker file to Git?

Generally, the decision to commit the `mockServiceWorker.js` file to VCS (i.e. Git) is up to you, but we **highly recommend doing so**.
