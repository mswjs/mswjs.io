...
If you are not using CRA, please create a custom teardown module and reference it using Jest's [`setupFilesAfterEnv`](https://jestjs.io/docs/en/configuration#setupfilesafterenv-array) option in your `jest.config.js`.
