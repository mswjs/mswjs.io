...
In this basic tutorial we are going to add Mock Service Worker to an existing [Create React App](https://create-react-app.dev) application. The steps described in this tutorial are framework-agnostic, so you can integrate mocking into any application.
