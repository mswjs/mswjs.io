...
In this basic tutorial we are going to add Mock Service Worker to an existing [Create React App](https://create-react-app.dev) application. Following these steps, you can integrate mocking into any application.
