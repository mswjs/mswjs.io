...
<template>
  <div
    ...
    class="sticky top-[var(--site-layout-top-height)] z-30 w-full border-b border-neutral-800 bg-neutral-900 min-[960px]:top-[calc(var(--site-layout-top-height)+4rem)] min-[960px]:pl-[var(--vp-sidebar-width)] min-[1280px]:hidden"
  >
    <div
