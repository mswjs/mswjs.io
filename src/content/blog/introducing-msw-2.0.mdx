...
This is a function called _response resolver_ in MSW, and it acts as a callback that receives the intercepted request and decides how to handle it. The shape of the response resolver hasn't change a bit since I first wrote it in 2018. Back in the day, I was rather inspired by functional programming and function composition in particular, which you can clearly see in the way you declare mocked responses in MSW:
