...
The Server Boundary API has been released in `msw@2.x.y` and is generally available for use. Update MSW to the latest version to take full advantage of concurrent test runs with predictable, isolated network:
...
<PageCard
  ...
  url="https://github.com/mswjs/msw/releases/tag/v2.x.y"
  title="v2.x.y"
