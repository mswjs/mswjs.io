---
title: 'v0 → v1'
description: Migration guidelines for version 1.0.
outline: [2, 3]
---

Version 1.0 is a huge overhaul of the library to address some of the long-standing design issues and missing features. Please take your time to read through the [documentation](/ecosystem/data/) to get familiar with the new concepts and APIs.
...
const users = new Collection({
  schema: z.object({ id: z.number(), lastName: z.string() }),
})
// ---cut---
...
> Learn more about [Querying](/ecosystem/data/querying).
...
> Learn more about [Relations](/ecosystem/data/relations/).
...
const revisionSchema = z.object({ updatedAt: z.number() })
const postSchema = z.object({
  id: z.string(),
  title: z.string(),
  get revision() {
...
> The library will automatically translate the `updatedAt` change of the reference revision into an implicit update.
