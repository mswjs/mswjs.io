...
Mock Service Worker fascilitates type-safe API mocking through _generic arguments_ in TypeScript. Using generic arguments, you can annotate things like path parameters, request and response body types, GraphQL variables, and more. Please see the examples of usage below.
