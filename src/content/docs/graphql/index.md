...
Mock Service Worker comes with first-class support for mocking [GraphQL](https://graphql.org/) APIs. You can develop, test, showcase, and debug your GraphQL applications using the `graphql` namespace exported by `msw/graphql`.
...
<div class="page-card-grid grid gap-5 md:grid-cols-2">
  <PageCard
    ...
    description="Learn how to intercept GraphQL operations."
  />
  <PageCard
    icon="GraphQLIcon"
    url="/docs/graphql/mocking-responses/"
    title="Mocking responses"
    description="Learn how to mock GraphQL responses."
  />
</div>
