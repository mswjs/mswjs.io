...
With this listener in place, you should see the console message _on every outgoing request_ that MSW intercepts. **Verify that the problematic request is printed.** If it is, continue to the next step.
