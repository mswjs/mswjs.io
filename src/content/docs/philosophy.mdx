...
When working with MSW, you will be writing [request handlers](/docs/concepts/request-handler) to intercept and respond to requests. It's important to approach those handlers from the _server's_ perspective since, effectively, you are describing how the server should behave in a particlar scenario.
