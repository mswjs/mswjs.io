...
order: 1
title: start()
description: Register the Service Woorker and starts the request interception.
---
...
Decide how to react to unhandled requests (i.e. thoes that do not have a matching request handler).
