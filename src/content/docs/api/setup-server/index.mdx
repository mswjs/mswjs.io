...
Reusing the same handlers between the browser and Node.js may have certain limitations. The browser-specific API you may use in your handlers, like `fetch` or `localStorage`, will not be available in Node.js. It would be your responsibility to polyfill any unsupported API as a part of your test setup.
