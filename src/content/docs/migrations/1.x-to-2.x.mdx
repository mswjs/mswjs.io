...
Our friends at Intuita have prepared a fantastic **collection of codemods** that can help you migrate to MSW 2.0.

- [**Codemods on GitHub**](https://github.com/intuita-inc/codemod-registry/tree/main/msw/2)
- [Getting started with Intuita](https://docs.intuita.io/docs/intro)
