...
1. <p class="flex items-center gap-2">
...
1. <p class="flex items-center gap-2">
     <span class="text-green-500 no-emoji">⬇⇣</span>
     <span>Server events.</span>
   </p>
1. <p class="flex items-center gap-2">
     <span class="text-primary no-emoji">⬆⬇</span>
     <span>Mocked events.</span>
   </p>

### System events

#### <span class="text-blue-500">▶</span> Connection opened
...
#### <span class="text-blue-500">×</span> Connection errored
...
#### <span class="text-blue-500">■</span> Connection closed
...
#### <span class="text-green-500 no-emoji">⬆⇡</span> Outgoing client message
...
#### <span class="text-primary no-emoji">⬆</span> Outgoing mocked client message
...
#### <span class="text-red-500 no-emoji">⬇⇣</span> Incoming server message
...
#### <span class="text-primary no-emoji">⬇</span> Incoming mocked server message
