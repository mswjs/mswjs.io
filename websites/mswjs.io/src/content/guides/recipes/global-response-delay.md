...
While you can control the response time (i.e. delay) of individual responses using the [`delay()`](/api/delay) API, sometimes you want to apply a delay consistently to _all_ mocked responses. There are a couple of ways you can do that with MSW.
...
<PageCard
icon="BeakerIcon"
url="/guides/recipes/higher-order-resolver"
