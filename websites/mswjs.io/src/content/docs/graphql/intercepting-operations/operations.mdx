...
> You can still access all the [Response resolver arguments](/docs/graphql/interception/#response-resolver) of the intercepted GraphQL operation, like `operationName`, `variables`, etc.
