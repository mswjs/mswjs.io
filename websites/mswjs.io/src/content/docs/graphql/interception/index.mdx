...
<div className="md:grid md:grid-cols-2 md:gap-x-5">
  <PageCard
    icon={GraphQLIcon}
    url="/docs/graphql/interception/queries"
    title="Queries"
    description="Learn about interceping GraphQL queries"
  />
  <PageCard
    icon={GraphQLIcon}
    url="/docs/graphql/interception/mutations"
    title="Mutations"
...
<PageCard
  icon={GraphQLIcon}
  url="/docs/graphql/interception/operations"
  title="Operations"
...
| `query`         | `string`                 | Raw GraphQL [query string](/docs/graphql/interception/queries#reading-raw-query). |
| `variables`     | `Record<string, any>`    | Parsed [variables](/docs/graphql/interception/variables) of this operation.       |
