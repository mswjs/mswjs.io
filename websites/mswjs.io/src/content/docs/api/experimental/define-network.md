...
Use this API to create a `network` instance that intercepts the traffic based on the provided [network sources](/docs/api/network-source) and gives you the means to manage the interception.
