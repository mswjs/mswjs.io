...
All themessages printed by MSW are graded by three criteria: _icon_, _stroke_, and _color_.
...
- <p>
    <span className="inline-block h-3 w-3 bg-blue-500 rounded-full" /> System
    events (<span className="text-blue-500">▶</span>,{' '}
    <span className="text-blue-500">■</span>,{' '}
    <span className="text-blue-500">×</span>);
  </p>
- <p>
    <span className="inline-block h-3 w-3 bg-red-500 rounded-full" /> Outgoing
    client messages (<span className="text-red-500">↑</span>,{' '}
    <span className="text-red-500">⇡</span>);
  </p>
- <p>
    <span className="inline-block h-3 w-3 bg-green-500 rounded-full" /> Incoming
    client messages (<span className="text-green-500">↓</span>,{' '}
    <span className="text-green-500">⇣</span>);
  </p>
- <p>
    <span className="inline-block h-3 w-3 bg-primary rounded-full" /> Mock
    events (either outgoing or incoming).
  </p>
...
```txt /00:00:00.000/#g /↑/#v /hello from client/ /17/#b
        timestamp         sent data
...
#### <span className="text-primary">⇡</span> Outgoing mocked client message
...
#### <span className="text-primary">⇣</span> Incoming mocked client message
