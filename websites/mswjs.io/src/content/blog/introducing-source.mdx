...
>
> Consider [sponsoring MSW](https://github.com/sponsors/mswjs) to support the effort behind the project and its developing ecosystem. That means a lot. Thank you.
...
I would like to say a huge thanks to [Weyert de Boer](https://github.com/weyert) for building [`tapico-msw-webarchive`](https://github.com/Tapico/tapico-msw-webarchive) and collaborating with me on Source!
