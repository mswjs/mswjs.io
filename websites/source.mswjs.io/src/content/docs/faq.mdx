...
Yes, you can. That doesn't mean that we need to ship a designated API for XYZ from Source. Use [`@msw/source`](https://github.com/mswjs/source) for inspiration to build a request generation utility, which you can then even publish to NPM for others to use!
